...
# create matrix x*y
# the R matrix (Revards matrix) is the matrix of return values i.e the value the agen recives
# for beeing in a state
...
def update(current_state, action, gamma):
    ...
    # update q-table
    q_val = R[current_state, action] + gamma * max_value
    Q[current_state, action] = q_val
    print('max_value', q_val)
